...
class HeadlinesGeneralAdapter(private val onClickAction: (article: Article, position : Int) -> Unit) : ListAdapter<Article, HeadlinesGeneralViewHolder>(HeadlinesDiffUtil){
