...
import com.search.news.core.recycler.NewsAdapter
import com.search.news.core.recycler.PaginationScrollListener
import com.search.news.core.recycler.modelRecycler.NewsInterface
import com.search.news.databinding.OneSourceListLayoutBinding
import com.search.news.headlines.presentation.presenter.presenterModel.fullNewsPresenter.FullNewsPresenterModel
import com.search.news.headlines.presentation.ui.FULL_NEWS_FRAGMENT
...
class OneSourceLIstFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        DaggerSourcesComponent.factory()
            .create(SearchApplication.getAstonApplicationContext.appComponent).inject(this)
        arguments?.let {
